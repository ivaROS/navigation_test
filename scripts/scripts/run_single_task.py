...
task= {'scenario': 'sector_extra', 'controller':'egocylindrical_pips_dwa', 'seed':seed, 'robot':'box_turtle', 'min_obstacle_spacing': min_obstacle_spacing, 'num_obstacles': num_barrels}
#
