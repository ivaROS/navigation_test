...
class CSVResultRecorder(ConsoleResultRecorder):
    ...
    def run(self):
        outputfile_name = "~/simulation_data/sgap_benchmark/turtlebot/v2/results_1_sg_fast_0.4_p_pose_2_3.5_0.5_po_1.2_1_fix6_1.1_rangefix_" + str(datetime.datetime.now())
...
def get_scenario_helper(self, task):
    ...
    class ScenarioHelper(object):
        ...
        def launch_gazebo(myself):
            ...
            myself.gazebo = GazeboHelper(task)
        ...
        def launch_controller(myself):
            ...
            myself.controller = ControllerHelper(task)
        ...
        def run(myself):
            ...
            record = task["record"] if "record" in task else None
